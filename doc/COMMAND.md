...
|**序号**|**键值**|**描述**|**关键字**|**备注**|
|:------:|:------:|:-------|:---------|:-------|
| 01 | 0x0101 | 上线请求 | ONLINE | '已'测试 |
| 02 | 0x0102 |	上线请求应答 | ONLINE-ACK | '已'测试 |
| 03 | 0x0103 | 下线请求 | OFFLINE | '已'测试 |
| 04 | 0x0104 | 下线请求应答 | OFFLINE-ACK | '已'测试 |
| 05 | 0x0105 | 客户端心跳 | PING | 用于连接保活 - '已'测试 |
| 06 | 0x0106 | 客户端心跳应答 | PONG | 用于连接保活 - '已'测试 |
...
| **序号** | **键值** | **命令含义** | **关键字** | **备注** |
|:------:|:------:|:-------|:---------|:-------|
| 01 | 0x0601 | 侦听层信息上报 | LSND-INFO | '已'测试 |
| 02 | 0x0602 | 侦听层信息上报应答 | LSND-INFO-ACK | 暂无 |
| 03 | 0x0603 | 转发层信息上报 | FRWD-INFO | '已'测试 |
