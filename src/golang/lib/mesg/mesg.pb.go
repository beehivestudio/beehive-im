...
//
// 命令ID: 0x0605
// 命令描述: 帧听层在线人数上报(LSND-USR-NUM)
// 协议格式:
type MesgLsndUsrNum struct {
	Nid              *uint32 `protobuf:"varint,1,req,name=nid" json:"nid,omitempty"`
	UsrNum           *uint32 `protobuf:"varint,2,req,name=usr_num" json:"usr_num,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}

func (m *MesgLsndUsrNum) Reset()                    { *m = MesgLsndUsrNum{} }
func (m *MesgLsndUsrNum) String() string            { return proto.CompactTextString(m) }
func (*MesgLsndUsrNum) ProtoMessage()               {}
func (*MesgLsndUsrNum) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{85} }

func (m *MesgLsndUsrNum) GetNid() uint32 {
	if m != nil && m.Nid != nil {
		return *m.Nid
	}
	return 0
...
func (m *MesgLsndUsrNum) GetUsrNum() uint32 {
	if m != nil && m.UsrNum != nil {
		return *m.UsrNum
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*MesgLsndUsrNum)(nil), "mesg_lsnd_usr_num")
}
...
var fileDescriptor0 = []byte{
	...
	,
}
